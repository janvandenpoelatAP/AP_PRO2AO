...
namespace Voorbeeld_09_1_FoodAPI.Migrations
{
    ...
    [Migration("20231127113232_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voorbeeld_09_1_FoodApi.Entities.Dish", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Voorbeeld_09_1_FoodApi.Entities.Ingredient", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("DishIngredient", b =>
                {
                    b.HasOne("Voorbeeld_09_1_FoodApi.Entities.Dish", null)
                        .WithMany()
                        .HasForeignKey("DishesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Voorbeeld_09_1_FoodApi.Entities.Ingredient", null)
                        .WithMany()
